...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-semibold text-gray-700">Liste des projects</h2>
            <a href="{{ route('admin.projects.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded inline-flex items-center">
            ...
            <tbody class="text-gray-600 text-sm">
                @foreach ($projects as $project)
                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200">
                        ...
                        <td class="p-1">
                            @if($project->image)
                                <img src="{{ asset('storage/' . $project->image) }}" alt="Image" class="w-10 h-10 rounded">
                            @else
                                N/A
                            @endif
                        </td>
                        ...
                        <a href="{{ route('admin.projects.show', $project->id) }}" class="text-gray-500 hover:text-gray-900">
