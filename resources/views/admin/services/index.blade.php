...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <table id="servicesTable" class="w-full mt-4 bg-white shadow-md rounded-lg text-gray-700 border border-gray-200">
            ...
            <tbody class="text-gray-600 text-sm">
                @foreach ($services as $service)
                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200">
                        ...
                        <td class="p-1">
                            @if($service->image)
                                <img src="{{ asset('storage/' . $service->image) }}" alt="Image" class="w-10 h-10 rounded">
                            @else
                                N/A
                            @endif
                        </td>
                        ...
                        <a href="{{ route('admin.services.show', $service->id) }}" class="text-gray-500 hover:text-gray-900">
