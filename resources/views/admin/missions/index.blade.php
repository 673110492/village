...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <table id="missionsTable" class="w-full mt-4 bg-white shadow-md rounded-lg text-gray-700 border border-gray-200">
            ...
            <tbody class="text-gray-600 text-sm">
                @foreach ($missions as $mission)
                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200">
                        ...
                        <a href="{{ route('admin.missions.show', $mission->id) }}" class="text-gray-500 hover:text-gray-900">
                        <i class="fa fa-eye"></i> <!-- Icône pour voir les détails -->
                        </a>
                            <a href="{{ route('admin.missions.edit', $mission->id) }}" class="text-blue-500 hover:text-blue-700">
                                <i class="fa fa-pencil"></i>
                            </a>

                            <form action="{{ route('admin.missions.destroy', $mission->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cette mission ?');">
                                @csrf
                                @method('DELETE')
                            ...
                            <form action="{{ route('admin.missions.toggleStatus', $mission->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
